Neste projeto, simulando uma estufa de hortaliças, um circuito eletrônico envolvendo um sensor de temperatura, uma buzina, um LED e um motor, controlados por meio de um Arduino. 
